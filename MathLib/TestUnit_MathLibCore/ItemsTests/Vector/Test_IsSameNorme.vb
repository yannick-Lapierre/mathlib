Namespace Obj.Vector
  ...
  Public Class IsSameNorme
        ...
        Public Sub Test_01()
            ...
            Assert.IsTrue(MathLib.Vector.IsSameNorme(_Vect1, _vect2))
        ...
        <TestMethod()> <Description("(0;0)(1;1) ;(0;0)(1,2)")> _
        Public Sub Test_07()

            '-- Initialisation des valeurs --------------------------------------
            _Vect1.SetValues(New MathLib.Point(0, 0), New MathLib.Point(1, 1))
            _vect2.SetValues(New MathLib.Point(0, 0), New MathLib.Point(1, 2))
            '--------------------------------------------------------------------

            Assert.IsFalse(MathLib.Vector.IsSameNorme(_Vect1, _vect2))
