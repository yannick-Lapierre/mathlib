...
Namespace Items
    ...
    Public Class SizesCollection

        Inherits Collections.ObjectModel.Collection(Of MathLib.Size)
        ...
        Public Sub FromArray(ByVal values() As MathLib.Size)
        ...
        Public Function ToArray() As MathLib.Size()
