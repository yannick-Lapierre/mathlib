...
Namespace Items
    ...
    Public Class RotationsCollection

        Inherits Collections.ObjectModel.Collection(Of MathLib.Rotation)
        ...
        Public Sub FromArray(ByVal values() As MathLib.Rotation)
        ...
        Public Function ToArray() As MathLib.Rotation()
