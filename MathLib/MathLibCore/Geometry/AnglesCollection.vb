...
Namespace Geometry
    ...
    Public Class AnglesCollection

        Inherits Collections.ObjectModel.Collection(Of MathLib.Angle)
        ...
        Public Sub FromArray(ByVal values() As MathLib.Angle)
        ...
        Public Function ToArray() As MathLib.Angle()
